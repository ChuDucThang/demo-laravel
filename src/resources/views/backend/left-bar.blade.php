...
<aside id="left-col" class="uk-light uk-visible@m">
    <div class="left-logo uk-flex uk-flex-middle">
        <img class="custom-logo" style="height:auto" src="{{url('/')}}/img/logo.png" alt="">
    </div>
    <div class="left-content-box  content-box-dark">
        <img src="{{url('/')}}/img/avatar.svg" alt="" class="uk-border-circle profile-img">
        <h4 class="uk-text-center uk-margin-remove-vertical text-light">Admin</h4>
    ...
    <div class="left-nav-wrap">
        <ul class="uk-nav uk-nav-default uk-nav-parent-icon" data-uk-nav>
            ...
            <li><a href="#"><span data-uk-icon="icon: comments" class="uk-margin-small-right"></span>Danh mục</a></li>
            <li><a href="new.html"><span data-uk-icon="icon: users" class="uk-margin-small-right"></span>Tin tức</a></li>
            <li class="uk-parent"><a href="#"><span data-uk-icon="icon: thumbnails" class="uk-margin-small-right"></span>Sản phẩm</a>
                <ul class="uk-nav-sub">
